  ...
  return (
    <section id="about" className="py-32 px-4 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center flex flex-col items-center gap-8 relative z-10">
        ...
        <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-gray-900 leading-[1.15] flex flex-wrap justify-center gap-x-3">
          <SplitText
        ...
        <SplitText
          ...
          className="max-w-2xl text-gray-600 text-lg md:text-xl leading-relaxed"
          delay={10}
          duration={0.5}
          ease="power3.out"
          splitType="chars"
