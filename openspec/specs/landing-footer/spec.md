...
The system SHALL render the Legac logo and brand name in the footer, consistent with the Navbar branding.

#### Scenario: Brand is visible in the footer
- **WHEN** the footer is rendered
- **THEN** the Legac logo icon and "Legac" text are displayed
